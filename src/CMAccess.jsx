...
export default function CMAccess(props) {
  ...
  return (
    <div className='fixed flex justify-center items-center w-[100%] h-[100%] top-0 left-0 right-0 bottom-0 bg-gray-500/25 z-40 text-copythirtiary'>
      <div className='w-[90%] sm:w-[30%] h-[300px] sm:h-[200px] bg-grape flex flex-col gap-4 justify-center items-center rounded-sm'>
        ...
        <div className='flex gap-5'>
          ...
          <button className='hover:opacity-80 bg-copythirtiary rounded-lg text-grape px-4 py-2' onClick={() => {
            handleContent()
          }}>Cancel</button>
        </div>
